...
fun AllSongsTab(
	...
	val (allSongs, _, _, sortOption, playlists, currentMediaItem) = uiState
	...
	Scaffold(
		...
		bottomBar = {
			SelectionModeBottomBar(inSelectMode, isSongsScreen = true) {
				val songs = if (allSongs is State.Success) allSongs.data else emptyList()
